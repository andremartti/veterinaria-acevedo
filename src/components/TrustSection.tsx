...
export function TrustSection() {
  return (
    <section aria-labelledby="opiniones-titulo" className="bg-cream-100 py-20 sm:py-24">
      <div className="container-page">
        <Reveal>
          <div className="relative overflow-hidden rounded-[2rem] border border-navy-900/8 bg-white p-8 shadow-[var(--shadow-soft)] sm:p-10 lg:p-12">
            <div
              aria-hidden="true"
              className="pointer-events-none absolute -top-28 -right-20 size-72 rounded-full bg-mist-100 blur-3xl"
            />

            <div className="relative flex flex-col gap-9 lg:flex-row lg:items-center lg:gap-12">
              {/* Calificación */}
              <div className="flex shrink-0 items-center gap-5">
                <p className="font-display text-[3.5rem] leading-none font-semibold text-navy-900 sm:text-[4.25rem]">
                  {ratingLabel}
                </p>
                <div>
              ...
              <div
                aria-hidden="true"
                className="hidden h-24 w-px shrink-0 bg-cream-200 lg:block"
              />

              <div className="min-w-0 flex-1">
                <h2
                  id="opiniones-titulo"
                  className="text-[clamp(1.4rem,2.6vw,1.9rem)] leading-snug font-semibold text-navy-900"
                >
            ...
            <p className="relative mt-8 flex items-center gap-2 border-t border-cream-200 pt-6 text-[0.8125rem] text-ink-muted">
